...
class Movie(models.Model):
    ...
    release_date_kr = models.DateField(blank=True, null=True)
    ...
    def check_is_complete(self):
        return (
            bool(self.poster_path)
            and bool(self.backdrop_path)
...
class Cast(models.Model):
    movie = models.ForeignKey(
        Movie, related_name="movie_actors", on_delete=models.CASCADE
    )
    actor = models.ForeignKey(
        Actor, related_name="actor_movies", on_delete=models.CASCADE
    )
